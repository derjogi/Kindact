...
priority: high
derivation: ported
ports_from: 031-core-metrics-framework
depends_on:
...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [031-core-metrics-framework](../../../implementation/specs/031-core-metrics-framework/README.md)

## Hybrid notes

Framework definition is substrate-agnostic and ports directly. Implementation is in [016](../016-impact-metrics/README.md), which puts bundles on DHT with EVM hash anchoring.
