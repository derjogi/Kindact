...
priority: medium
derivation: ported
ports_from: 026-015i-ui-lens-config
tags:
- frontend
- ux
- lens
...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [026-015i-ui-lens-config](../../../implementation/specs/026-015i-ui-lens-config/README.md)

## Hybrid notes

UI port — **renamed in this spec set to Cell Configuration**. The lens model is replaced by the cell architecture ([030](../030-cell-architecture-and-registry/README.md)). UI manages anchor subscriptions ([042](../042-anchor-and-subscription-model/README.md)), cell memberships, cell creation flow, and cell promotion proposals.
