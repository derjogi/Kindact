...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [017-work-planning](../../../implementation/specs/017-work-planning/README.md)

## Hybrid notes

Work-planning logic ports directly. Under the hybrid: work packages, milestones, and approvals are DHT entries in the issue's home cell ([008](../008-work-verification-rewards/README.md)). On-chain anchoring of approved work packages flows through the bridge ([040](../040-bridge-specification/README.md)).
