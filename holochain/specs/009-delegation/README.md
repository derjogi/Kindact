...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [009-delegation](../../../implementation/specs/009-delegation/README.md)

## Hybrid notes

Delegation logic is substrate-agnostic in concept. Under the hybrid: delegation entries live as DHT entries in the home cell ([006](../006-deliberation-cell/README.md)); on-chain delegation records (when a delegate casts a binding tally) flow through the bridge ([040](../040-bridge-specification/README.md)). References below to AT Proto records read as DHT entries; references to AppView reads route through the conductor ([014](../014-conductor-and-bridge-service/README.md)).
