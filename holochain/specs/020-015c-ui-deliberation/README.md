...
priority: high
derivation: ported
ports_from: 020-015c-ui-deliberation
tags:
- frontend
- ux
- deliberation
...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [020-015c-ui-deliberation](../../../implementation/specs/020-015c-ui-deliberation/README.md)

## Hybrid notes

UI port. Deliberation surfaces are zome calls against the home cell per [006](../006-deliberation-cell/README.md) instead of AppView reads.
