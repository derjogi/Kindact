...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [021-015d-ui-voting](../../../implementation/specs/021-015d-ui-voting/README.md)

## Hybrid notes

UI port. Vote casting is a free DHT entry per [007](../007-voting-engine/README.md); fluid voting UI updated to indicate in-cell instant feedback vs. on-chain finalization status.
