...
priority: medium
derivation: ported
ports_from: 025-015h-ui-profile
tags:
- frontend
- ux
- identity
...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [025-015h-ui-profile](../../../implementation/specs/025-015h-ui-profile/README.md)

## Hybrid notes

UI port. Profile shows multiple Holochain agent keys per [002](../002-identity-primitive/README.md), runtime mode selector per [047](../047-holo-hosting-strategy/README.md), and cell membership list.
