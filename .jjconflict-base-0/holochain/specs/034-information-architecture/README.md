...
priority: high
derivation: ported
ports_from: 034-information-architecture
tags:
- frontend
- design
- ux
...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [034-information-architecture](../../../implementation/specs/034-information-architecture/README.md)

## Hybrid notes

IA port — substrate-agnostic. Cell-related navigation replaces lens-related navigation per [030](../030-cell-architecture-and-registry/README.md).
