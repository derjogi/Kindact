...
priority: high
derivation: ported
ports_from: 036-anonymization-visual-language
tags:
- frontend
- design
- privacy
...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [036-anonymization-visual-language](../../../implementation/specs/036-anonymization-visual-language/README.md)

## Hybrid notes

Anonymization port — substrate-agnostic. Note: agent-key pseudonymity in cells is the default; this spec's anonymization patterns apply on top.
