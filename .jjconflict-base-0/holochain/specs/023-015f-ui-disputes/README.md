...
priority: medium
derivation: ported
ports_from: 023-015f-ui-disputes
tags:
- frontend
- ux
- disputes
...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [023-015f-ui-disputes](../../../implementation/specs/023-015f-ui-disputes/README.md)

## Hybrid notes

UI port. Direct EVM challenge path preserved; new cross-cell challenge categories per [012](../012-dispute-resolution/README.md) (binding-invalid, quorum-fraudulent, non-conformant-cell) added.
