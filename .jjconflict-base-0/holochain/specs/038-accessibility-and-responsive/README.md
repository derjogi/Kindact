...
priority: high
derivation: ported
ports_from: 038-accessibility-and-responsive
tags:
- frontend
- design
- a11y
...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [038-accessibility-and-responsive](../../../implementation/specs/038-accessibility-and-responsive/README.md)

## Hybrid notes

A11y & responsive port — fully substrate-agnostic.
