...
priority: high
derivation: ported
ports_from: 022-015e-ui-implementation
tags:
- frontend
- ux
- verification
...
> **Status**: Exploratory · **Derivation**: ported · **Counterpart in implementation/**: [022-015e-ui-implementation](../../../implementation/specs/022-015e-ui-implementation/README.md)

## Hybrid notes

UI port. Implementation flow: claim/report/verify entries via the home cell per [008](../008-work-verification-rewards/README.md). Local-mutual-credit option exposed alongside canonical $CC payment.
