...
# Build script for ProofPoll DNA v1.0
...
if [ -d "$RESOURCES_DIR" ] || [ -d "$SCRIPT_DIR/../src-tauri" ]; then
    ...
    cp workdir/proofpoll_v1_0_happ.happ "$RESOURCES_DIR/"
...
echo ""
echo "Outputs:"
echo "  - DNA: workdir/proofpoll_v1_0.dna"
echo "  - hApp: workdir/proofpoll_v1_0_happ.happ"
