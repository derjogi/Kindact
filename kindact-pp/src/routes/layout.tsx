...
export default component$(() => {
    ...
    const startBackup = async () => {
      ...
      try {
        ...
        stopAutoBackup = startAutoBackup({
          ...
          onSuccess: (r) => console.log(`[Kindact] Vault backup: ${r.dataSize} bytes`),
          onError: (e) => console.warn("[Kindact] Vault backup skipped:", e.message),
        });
      } catch {
                      ...
                      .then(async ({ linkFlowstaIdentity }) => {
                        try {
                          ...
                          if (result.success) {
                            ...
                            console.log("[Kindact] DHT identity link re-created after migration");
                          }
                        } catch {
   ...
   * attributable to Kindact's local agent.
   */
            ...
            {status.value.conductor_status.status === "error" ? (
              <>
                ...
                <div class="text-center max-w-md">
                  ...
                  <p class="text-gray-600 text-xs mt-2">Reopen Kindact after closing to reconnect.</p>
                </div>
              </>
            ) : (
              <>
